# Generated by Django 3.0.3 on 2020-05-07 18:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='cadettracker.Company')),
        ...
        migrations.CreateModel(
            name='CompanyHasPersonnel',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('Co', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadettracker.Company')),
                ('person', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='cadettracker.Personnel')),
            ],
        ),
        migrations.AddField(
